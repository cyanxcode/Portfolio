<h1 class="karantina text-right py-10 px-20 text-white text-5xl md:text-7xl lg:text-8xl leading-tight uppercase whitespace-nowrap">
    My Work
</h1>
<div class="grid grid-cols-1 md:grid-cols-2 p-6 gap-4 gap-y-20 jetbrains">
